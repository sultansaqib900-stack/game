...
export const WEAPONS = {
  pulse: {
    ...
    base: { cd: 0.45, dmg: 16, count: 1, speed: 640, pierce: 0, life: 1.15, area: 1, spread: 0.1, knock: 70, crit: 0.05 },
    levels: [
...
export const ENEMIES = {
  grunt:   { name: 'Drifter', behavior: 'chase', hp: 16, speed: 62, dmg: 5, r: 13, color: '#ff5d7a', shape: 'hex', xp: 1, coin: 0.06, weight: 100, minTime: 0 },
  runner:  { name: 'Sprinter', behavior: 'chase', hp: 10, speed: 132, dmg: 4, r: 10, color: '#ffd23d', shape: 'tri', xp: 1, coin: 0.05, weight: 70, minTime: 45 },
...
/* XP curve: cheap early levels so builds come online fast, expensive after 12
   so a full build lands around minute 6-8 of a 20-minute run */
export const xpForLevel = (n) => n < 12
  ? Math.floor(3 + n * 1.15 + n * n * 0.055)
  : Math.floor(10 + n * 2.2 + n * n * 0.22);
